...
/*
 * Demofs (Version 6) - Fully Correct Block-Backed Filesystem with Directory Support
 * 
...
{
	pr_info("demofs_v6: registering block-backed filesystem with directory support\n");
	return register_filesystem(&demofs_fs_type);
}

static void __exit demofs_exit(void)
{
	pr_info("demofs_v6: unregistering block-backed filesystem\n");
...
MODULE_DESCRIPTION("A block-backed virtual filesystem (Version 6 - Supports Directory Creation)");
